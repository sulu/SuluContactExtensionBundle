...
namespace Sulu\Bundle\ContactExtensionBundle\Command;
...
class CompleteDataCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        /** @var \Sulu\Bundle\ContactExtensionBundle\Import\DataCompleter $completer */
        $completer = $this->getContainer()->get('sulu_contact_extension.data_completer');
        // set locale
